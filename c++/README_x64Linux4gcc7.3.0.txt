...
data type msg from listeners.idl.
This example builds two applications, named listeners_publisher and
...
> make -f makefile_listeners_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_listeners_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the listeners_publisher.cxx
file where it says:
...
Run /opt/rti_connext_dds-6.0.1/resource/scripts/rtisetenv_x64Linux4gcc7.3.0.bash
...
> objs/x64Linux4gcc7.3.0/listeners_publisher <domain_id> <sample_count>
> objs/x64Linux4gcc7.3.0/listeners_subscriber <domain_id> <sample_count>
